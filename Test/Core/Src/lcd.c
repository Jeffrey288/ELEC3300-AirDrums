...
{	
	...
	LCD_OpenWindow (usCOLUMN,usCOLUMN,usPAGE,usPAGE); // Allocate the "Memory" for the access
	LCD_FillColor (1, usColor); // Allocate the "Memory" for storing (Displaying the data)
